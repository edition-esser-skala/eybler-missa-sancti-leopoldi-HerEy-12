...
\book {
    ...
    \score { %\articulate
      <<
        ...
        \new StaffGroup <<
          ...
          >>
          \new Staff \with { instrumentName = \markup \center-column { "clno" "1, 2" } } <<
  ...
  \bookpart {
    ...
    \score { %\articulate
      <<
        \new StaffGroup \with { \setGroupDistance #12 #15 } <<
          \new Staff {
            \set Staff.instrumentName = \markup \center-column { "ob" "1, 2" }
            \set Staff.soloText = \markup \remark \medium "ob 1"
          ...
          \new Staff {
            ...
            \set Staff.soloText = \markup \remark \medium "cl 1"
            % \transpose c a,
            \partCombine #'(0 . 10) \AgnusLongClarinettoI \AgnusLongClarinettoII
          }
          \new Staff {
            \set Staff.instrumentName = \markup \center-column { "fag" "1, 2" }
            \set Staff.soloText = \markup \remark \medium "fag 1"
